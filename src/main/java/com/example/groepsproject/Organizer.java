...
public class Organizer extends Person {
    ...
    public Organizer(String firstName, String lastName, String mail, String username, String password, LocalDate dateOfBirth, String IBANnr, int dummy) {
        super(firstName, lastName, mail, username, password, dateOfBirth, IBANnr);
    }

    public Organizer(String firstName, String lastName, String mail, String username, String password, LocalDate dateOfBirth, String IBANnr) throws SQLException {
        ...
        String sql = "INSERT INTO Organizer (USERNAME, name, firstname, mail, password, date_of_birth, age, IBAN_nr) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    static public void makeNewOrganizer(String firstname, String lastName, String mail, String username, String password, LocalDate dateOfBirth, String IBANnr) throws SQLException {
        Organizer organizer = new Organizer(firstname, lastName, mail, username, password, dateOfBirth, IBANnr);
    }
    ...
    public static boolean usernameExists(String username) throws SQLException {
        //SQL String definiëren
        String sql = "SELECT USERNAME FROM Organizer";
